...
In \LaTeX{} hingegen modifiziert der Nutzer eines oder mehrere \texttt{.tex}-Dokumente, die nur reinen Text enthalten und mit jedem beliebigen Text-Editor bearbeitet werden können.
