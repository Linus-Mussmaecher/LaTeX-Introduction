...
\begin{latexlisting}
	...
	\end{equation*}
\end{latexlisting}
Wir sehen, dass \latexcommand{num} sowohl \key{.} als auch \key{,} als Deziimaltrennzeichen akzeptiert und auch Exponenten und wissenschaftliche Notation korrekt setzt.
