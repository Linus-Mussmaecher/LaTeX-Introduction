...
Letzteres Problem sollte mit der nächsten Version von \latexpackage{nchairx} korrigiert werden, wer eine weitere Sprache, die aktuell noch nicht unterstützt wird, zu \latexpackage{nchairx} beitragen möchte, kann sich gerne per Mail bei mir melden (\texttt{linus.mussmaecher@gmail.com}).
